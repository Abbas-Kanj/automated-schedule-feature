...
import { SCHEDULE_ICON_OPTIONS } from '../../data/data'
import { type ScheduleIcon } from '../../data/schema'

type IconPickerFieldProps = {
  value: ScheduleIcon | undefined
  onChange: (value: ScheduleIcon | undefined) => void
  disabled?: boolean
}
...
export function IconPickerField({
  ...
  const selected = SCHEDULE_ICON_OPTIONS.find((o) => o.value === value)
